...
export const useText = () => {
  ...
  const text = {
    ar: {
      ...
      ourPartnersText: "شركاؤنا في العمل الإنساني",
      pagestText: "الصفحات",
      ...
      noProjectFound: "لم يتم العثور على مشاريع",
      viewCaseText: "مشاهدة الحالة",
      viewStoryText: "مشاهدة القصة",
      sanOnScoialMediaText: "السنابل على السوشل ميديا",
      contactFormText: "فورم التواصل",
    ...
    en: {
      ...
      sanOnScoialMediaText: "Sanabelsao on Social Media",
